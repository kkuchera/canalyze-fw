...
# Compilation flags
CFLAGS = -g -Os -std=c99 -pedantic -Wall -Wextra -Werror -ffunction-sections -fdata-sections -mthumb -mcpu=$(CPU) $(DEFS)
CFLAGSLIB = -g -Os -Wall -ffunction-sections -fdata-sections -mthumb -mcpu=$(CPU) $(DEFS)
